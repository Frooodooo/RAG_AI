...
// Performance optimization: Lazy load WorkflowVisualizer (and its heavy @xyflow/react dependency)
// to reduce the main bundle size since it's only needed on the workflow tab.
