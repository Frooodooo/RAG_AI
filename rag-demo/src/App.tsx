...
// ⚡ Bolt: Lazy load WorkflowVisualizer to code-split the heavy @xyflow/react dependency (~2MB)
// out of the main bundle, reducing initial load time for users who only use the Chat tab.
