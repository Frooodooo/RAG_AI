...
// ⚡ Bolt: Lazy load WorkflowVisualizer (and its heavy @xyflow/react dependency)
// since it's only needed when the user switches to the workflow tab.
      ...
      <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        {activeTab === 'workflow' && (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            ...
            <Suspense fallback={
              <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--t3)', fontFamily: 'var(--font)', fontSize: '14px' }}>
