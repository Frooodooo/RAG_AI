...
// ⚡ Bolt: Lazy load the WorkflowVisualizer to code-split the massive @xyflow/react dependency.
// This prevents users who only use the 'Chat' or 'Documents' tabs from downloading the visualization library.
