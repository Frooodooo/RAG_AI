...
// ⚡ Bolt: Lazy load WorkflowVisualizer to split the heavy @xyflow/react dependency (~600KB)
// out of the main bundle, since the workflow visualizer is only needed when the user
// navigates to the "Workflow" tab.
