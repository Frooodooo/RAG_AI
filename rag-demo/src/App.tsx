...
// ⚡ Bolt: Lazy load WorkflowVisualizer to code-split the heavy @xyflow/react dependency.
// This significantly improves initial bundle size and main thread blocking, as the
// visualization graph is only needed when the user explicitly opens the Workflow tab.
