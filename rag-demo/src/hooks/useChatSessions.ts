...
export function useChatSessions() {
    ...
    // ⚡ Bolt: Offload synchronous localStorage writes from state setters to a single effect. This prevents blocking the main thread during rapid state updates and eliminates duplicate writes in React StrictMode.
    useEffect(() => {
