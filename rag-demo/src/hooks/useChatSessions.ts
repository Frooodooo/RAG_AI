...
export function useChatSessions() {
    ...
    // Optimization: Synchronous localStorage writes inside React state setters block the main thread. Using useEffect prevents jank and duplicate writes in StrictMode.
    useEffect(() => {
