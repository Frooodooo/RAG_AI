...
const SessionItem = memo(function SessionItem({
    ...
    return (
        <div
            ...
            className="group relative flex items-start gap-2.5 mx-1.5 mb-0.5 px-3 py-2.5 rounded-lg cursor-pointer select-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[var(--accent)]"
            style={{
                background: isActive
        ...
        >
            ...
            <ChatBubbleIcon
                width="16" height="16"
                style={{ color: isActive ? 'var(--t-accent)' : 'var(--t3)', flexShrink: 0, marginTop: '3px' }}
            />
                        ...
                        {deletePhase === 'confirm' ? (
                            <>
                                ...
                                <button
                                    ...
                                    style={{ background: 'rgba(255,255,255,0.08)', color: 'var(--t3)', border: 'none', cursor: 'pointer' }}
                                >
                            ...
                            <button
                                ...
                                className="w-7 h-7 flex items-center justify-center rounded transition-all"
                                style={{ background: 'transparent', color: 'var(--t3)', border: 'none', cursor: 'pointer' }}
        ...
        <aside className={`session-sidebar ${collapsed ? 'collapsed' : ''}`}>
            ...
            <div className="session-sidebar-body">
                    ...
                    <div className="px-2 pt-2 pb-1">
                        ...
                        >
                            <SearchIcon width="14" height="14" strokeWidth="2"
                                style={{ color: 'var(--t3)', flexShrink: 0 }} aria-hidden="true" />
                            <input
                                ref={searchInputRef}
                                type="text"
                                value={search}
                ...
                <div role="list" className="flex-1 overflow-y-auto py-1.5">
                    {filtered.length === 0 && (
                        <p className="text-xs text-center py-8 px-3" style={{ color: 'var(--t3)' }}>
