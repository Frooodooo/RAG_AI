  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="hover:bg-[rgba(248,113,113,0.12)] hover:border-[rgba(248,113,113,0.25)] hover:text-[#f87171] transition-all duration-[140ms] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[#f87171]"
        style={{
          width: '28px', height: '28px', borderRadius: 'var(--r-sm)',
          background: 'transparent', border: '1px solid transparent',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      {downloadError && (
        <div style={{
          ...
          <button onClick={() => setDownloadError(null)} aria-label="Dismiss error" className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f87171] rounded-sm" style={{ marginLeft: 'auto', background: 'none', border: 'none', cursor: 'pointer', color: '#f87171', fontSize: '16px', lineHeight: 1 }}>×</button>
        </div>
      )}
