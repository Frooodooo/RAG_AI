  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="hover:bg-[rgba(248,113,113,0.12)] hover:border-[rgba(248,113,113,0.25)] hover:text-[#f87171] transition-all duration-[140ms] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[var(--red)]"
        style={{
          width: '28px', height: '28px', borderRadius: 'var(--r-sm)',
          background: 'transparent', border: '1px solid transparent',
