  ...
  return (
    ...
    >
      ...
      <button
        ...
        title={isDownloading ? t('docs.downloading') as string : t('docs.download') as string}
        aria-label={isDownloading ? t('docs.downloading') as string : t('docs.download') as string}
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        <div style={{
          ...
          <input
            type="text"
            placeholder={t('docs.search_placeholder') as string}
            aria-label={t('docs.search_placeholder') as string}
            value={searchQuery}
