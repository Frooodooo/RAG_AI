    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      {downloadError && (
        <div style={{
          ...
          <button aria-label="Dismiss error" onClick={() => setDownloadError(null)} className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f87171] rounded-sm" style={{ marginLeft: 'auto', background: 'none', border: 'none', cursor: 'pointer', color: '#f87171', fontSize: '16px', lineHeight: 1 }}>×</button>
        </div>
      )}

      {/* Search Bar */}
      <div style={{ display: 'flex', gap: '10px' }}>
        <div className="focus-within:outline focus-within:outline-2 focus-within:outline-[var(--accent)]" style={{
          flex: 1,
