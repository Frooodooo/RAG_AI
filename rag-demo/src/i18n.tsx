...
const translations = {
    lv: {
        ...
        'chat.clear': 'Notīrīt',
        'chat.clear_confirm': 'Vai tiešām vēlaties dzēst šo sarunu? Šo darbību nevar atsaukt.',
    ...
    en: {
        ...
        'chat.clear': 'Clear',
        'chat.clear_confirm': 'Are you sure you want to clear this conversation? This action cannot be undone.',
