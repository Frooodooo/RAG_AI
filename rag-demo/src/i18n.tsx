...
const translations = {
    lv: {
        ...
        'chat.clear': 'Notīrīt',
        'chat.confirm_clear': 'Vai tiešām vēlaties notīrīt šo sarunu? Šo darbību nevar atsaukt.',
    ...
    en: {
        ...
        'chat.clear': 'Clear',
        'chat.confirm_clear': 'Are you sure you want to clear this conversation? This cannot be undone.',
