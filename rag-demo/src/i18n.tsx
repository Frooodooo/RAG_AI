...
const translations = {
    lv: {
        ...
        'chat.clear': 'Notīrīt',
        'chat.clear_confirm': 'Vai tiešām vēlaties notīrīt šo sarunu?',
        'chat.clear_title': 'Notīrīt sarunu',
    ...
    en: {
        ...
        'chat.clear': 'Clear',
        'chat.clear_confirm': 'Are you sure you want to clear this conversation?',
