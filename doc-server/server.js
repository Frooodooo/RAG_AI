...
app.delete('/docs/:id', async (req, res) => {
  ...
  try {
    // Use QDRANT_URL env var; default to localhost for native (non-Docker) deployments
    // Set QDRANT_URL=http://host.docker.internal:6333 if running doc-server inside Docker
