...
## 2024-05-24 - Keyboard Focus with Inline Styles
**Learning:** In Cosmos Dark, components with dynamic inline styles (like the Language Switcher and Workflow Selector) often lack focus states.
**Action:** Use Tailwind's `focus-visible:outline` utilities (e.g., `focus-visible:outline-[var(--accent)]`) via the `className` prop alongside inline styles to ensure keyboard accessibility.
