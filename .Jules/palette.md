...
## 2024-05-25 - Destructive Actions and Confirmation
**Learning:** Users can accidentally clear their entire conversation history by clicking the "Clear" button without a confirmation prompt.
**Action:** Always wrap destructive actions like clearing a conversation or deleting a document in a confirmation dialog (`window.confirm`) to prevent accidental data loss.
